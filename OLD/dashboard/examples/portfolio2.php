...
function setValue(){
    ...
    document.forms["sampleForm"].submit();
        ...
        <div id="selld" class="popup">
            ...
            <br><br>
            <form action="portfolio.php" method="post" name="sellForm" id = "sellForm">
                  Sell
                  <input type="text" name="amount" placeholder="0.00 (USD)" id="txtField">
                  <input type="hidden" name="coin" id="coin1" value="">
                    of  <span id="mycoin1"></span>  
                  <br><br>
                  <a href="" onclick="sellValue();"><input type="submit" name="sell" id="submitButton"></a>
             </form>
        </div>
 <script>
function sellValue(){
    document.sellForm.coin1.value = boin;
